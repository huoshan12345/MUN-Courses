...
$F = F_1 ∪ F_2$  
$F = F_1 ∪ F_2$  
$δ = Δ_1 ∪ Δ_2 ∪ \lbrace (s_0,λ,s_{01}), (s_0,λ,s_{02}) \rbrace$
...
$δ = Δ_1 ∪ Δ_2 ∪ (F_1 × \lbrace λ\ \rbrace × \lbrace s_{02} \rbrace)$ (NOTE: add a λ transition that is from $F_1$ to $s_{02}$)  
...
$F = \lbrace f_0\ \rbrace$  
$δ = Δ_1 ∪ (F_1 × \lbrace λ \rbrace × \lbrace s_{01}) ∪ (s_0 × λ × s_{01}) ∪ (F_1 × \lbrace λ \rbrace × F) ∪ (s_0 × λ × f_0)$  
