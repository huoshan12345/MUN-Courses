...
#### CFG for $\lbrace 0^n1^n\ |\ n ≥ 1 \rbrace$
...
#### CFG for $\lbrace 0^m1^n\ |\ m ≥ n \rbrace$
...
$L_1 = \lbrace a^nb^nc^md^m\ |\ n,m ≥ 1 \rbrace ∪ \lbrace a^nb^mc^md^n\ |\ n,m ≥ 1 \rbrace$

$L_2 = \lbrace 0^i1^j2^k\ |\ i = j ∨ j = k\ \rbrace
